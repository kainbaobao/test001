...
<script type="text/javascript" src="<%=basePath%>js/payIn.js"></script>
<table id="adata" class="easyui-datagrid" toolbar="#tb" pagination="true" title="收入管理" fitColumns="true" border="0"
    ...
    <thead>   
        <tr>   
            ...
            <th field="id">id</th>  
            <th field="name">支出名称</th>   
            <th field="money">支出金额</th>  
            <th field="aname">所属账户</th>     
            <th field="typeName">支出类型</th>   
...
<div id="tb">
    <a href="javascript:openAddOrUpdatePayOutDialog()"  class="easyui-linkbutton" iconCls="icon-add" plain="true" >添加支出</a>
